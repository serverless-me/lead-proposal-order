...
namespace LPO_Phone
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        {   
            {"View1",   @"<View><Query><OrderBy><FieldRef Name='ID' /></OrderBy></Query><RowLimit>15</RowLimit><ViewFields>{0}</ViewFields></View>"}
        };
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Title'/><FieldRef Name='ContactCp'/><FieldRef Name='CustomerCp'/><FieldRef Name='Activity'/><FieldRef Name='EstimatedOrderVolume'/><FieldRef Name='Deadline'/><FieldRef Name='EstProjectStart'/><FieldRef Name='EstProjectEnd'/><FieldRef Name='Language1'/><FieldRef Name='Requirements'/><FieldRef Name='LPOStatus'/><FieldRef Name='ProposalManager'/><FieldRef Name='CMcp'/><FieldRef Name='CommercialManagerDeputy'/><FieldRef Name='RiskClassification'/><FieldRef Name='NonDisclosure'/><FieldRef Name='ProductionCostInternal'/><FieldRef Name='ProductionCostExternal'/><FieldRef Name='Material'/><FieldRef Name='TotalCost'/><FieldRef Name='Price'/><FieldRef Name='MargePercentage'/><FieldRef Name='AcknowledgePolicy'/><FieldRef Name='EMail'/><FieldRef Name='Attachments'/><FieldRef Name='TransmissionDate'/><FieldRef Name='TransmissionUser'/><FieldRef Name='OrderCoordinator'/><FieldRef Name='NoteToOrderManagement'/><FieldRef Name='_UIVersionString'/><FieldRef Name='ContactImage'/><FieldRef Name='CustomerLogo'/>";
